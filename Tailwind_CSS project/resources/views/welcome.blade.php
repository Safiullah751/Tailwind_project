...
<nav class="relative container mx-auto p-6">
    ...
    <div class="flex items-center  justify-between">
        ...
        {{-- Button --}}
        <a href=""
            class="hidden xl:block p-2 px-10 text-white bg-orange-500 rounded-full pt-3 hover:bg-black delay-100 ease-in-out">Get
            Started</a>
    </div>
</nav>
    ...
    <div class="container flex flex-col-reverse md:flex-row items-center px-6 mx-auto space-y-0 md:space-y-0">
        ...
        <div class="flex flex-col mb-32 space-y-12  md:w-1/2">
            ...
            <div class="flex justify-center md:justify-start">
                <a href=""
                    class="p-2 px-10 text-white bg-orange-500 rounded-full pt-3 hover:bg-black delay-100 ease-in-out">Get
                    Started</a>
            </div>
        </div>
...
<section id="features">
  ...
  {{-- TestTimonails --}}
         <section id="testtimonails">
            <div class=" mx-auto max-w-6xl text-center px-5 mt-32">
                <h2 class="text-center px-12 text-4xl font-bold" >
